 ...
 *
 * Initializes a virtual network device using the file descriptor, IP and
 ...
 * device.
 * @param[in] device An integer containing the file descriptor of the TUN/TAP
 * device.
 * @param[in] ipAddress A character array containing the IP Address in
 * decimal notation.
 * The address is assigned to the virtual network device.
 * @param[in] macAddress A character array containing the MAC Address in
 * legible format.
 * The address is assigned to the virtual network device.
 ...
 * @param[in, out] ethHeader  A struct structured with fields of apt sizes
 * to contain the information of the ethernet header.
 * Source and destination MAC addresses and payload type are modified for
 * correct transmission.
 * @param[in] ethertype An integer containing the type of payload of the
 * modified frame which is to be transmitted.
 * @param[in] length An integer containing the length of the ethernet header
 * provided.
 * @param[in] destination A character array containing the MAC address of
